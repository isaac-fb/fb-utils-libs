  ...
  var methods = {
      ...
      updateCornerPosition : function() {
          ...
          if ($(cells).length) {
              ...
              var t = parseInt($(corner).offset().top) - $('#custom-rates').offset().top + $(corner).parent().outerHeight() - 62;
              var l;
              if($(window).width() < 960){
                l = parseInt($(corner).offset().left) + $(corner).outerWidth() - 10 + $('#vertical-navigation').width();
              } else {
                l = parseInt($(corner).offset().left) + $(corner).outerWidth() - 10;
